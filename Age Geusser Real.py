...
def display_result():
    ...
    # Display result
    tk.Label(frame, text="YOUR AGE IS BETWEEN:", font=("Helvetica", 26, "bold"), fg="green", bg="lightblue").pack(pady=20)
    tk.Label(frame, text="5 to 85 Years Old", font=("Helvetica", 40, "bold"), fg="red", bg="lightblue").pack(pady=20)
